...
declare class Buffer extends Uint8Array {
    ...
    write(string: string, encoding?): number;
    write(string: string, offset: number, encoding?): number;
    write(string: string, offset: number, length: number, encoding?): number;
    toString(encoding?, start?: number, end?: number): string;
